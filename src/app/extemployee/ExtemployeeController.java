 ...
 */
public class ExtemployeeController extends GenericController<Extemployee> implements Initializable, ControlledScreen {
    ...
    @FXML
    private TableView<Extemployee> extemployeeTable;

    private ScreensController myController;

    @Override
    public void initialize(URL url, ResourceBundle resources) {
        genericInitializer( extemployeeTable, resources);
    }
