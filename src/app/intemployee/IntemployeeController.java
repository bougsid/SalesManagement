 ...
 */
public class IntemployeeController extends GenericController<Intemployee> implements Initializable, ControlledScreen {
    ...
    @FXML
    private TableView<Intemployee> intemployeeTable;

    private ScreensController myController;

    @Override
    public void initialize(URL url, ResourceBundle resources) {
        genericInitializer( intemployeeTable, resources);
    }
